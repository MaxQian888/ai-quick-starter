...
SYSTEM_DEFINITIONS = {
    ...
    "react-i18next": {
        ...
        "forbid": ("next-intl", "react-intl", "vue-i18n", "i18next"),
    },
    "i18next": {
        "kind": "function-based",
        "packages": ("i18next",),
        "import_patterns": (r"from\s+['\"]i18next['\"]",),
        "usage_patterns": (
            r"\bi18next\.(?:t|init|use)\s*\(",
            r"\bi18n\.t\s*\(",
        ),
        "path_patterns": (r"(^|/)locales?/", r"(^|/)i18next\.(ts|tsx|js|jsx)$"),
        "forbid": ("next-intl", "vue-i18n"),
    },
    "react-intl": {
        "kind": "hook-based",
        "packages": ("react-intl",),
