...
(or `uv run --python 3.11 scripts/build_e2e_change_plan.py ...` when uv is the standard interpreter for the repo — the script is stdlib-only and does not require uv).
