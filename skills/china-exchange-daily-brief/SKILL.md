...
description: Fetch latest updates from major China stock exchanges (SSE, SZSE, HKEX, optional BSE), then produce itemized summaries with source links and images. Use when users ask for same-day exchange news, exchange daily brief, market bulletin, or "summarize each item with links and pictures".
---
