...
class SkillContractTests(unittest.TestCase):
    ...
    def test_module_exposes_expected_navigation_files(self) -> None:
        expected_paths = [
            ...
            self.skill_root / "references" / "current-workflow.md",
            self.skill_root / "references" / "cleanup-rules.md",
            self.skill_root / "references" / "artifact-refresh.md",
            self.skill_root / "scripts" / "build_change_cleanup_report.py",
            self.skill_root / "scripts" / "reconcile_change_artifacts.py",
            self.skill_root / "scripts" / "sync_change_tasks.py",
        ]
