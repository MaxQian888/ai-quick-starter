...
Recent commit history is supporting evidence, not a standalone license to ignore a path. If the evidence is weak, leave the item for human review instead of auto-adding it.
